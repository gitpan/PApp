...
if v:version >= 600
   ...
   syn cluster xmlCdataHook add=papp_CDATAx
endif
...
syn region papp_CDATAh matchgroup=xmlCdataDecl start="<!\[CDATA\[" end="\]\]>" contains=papp_prep,papp_ph_perl,papp_ph_html,papp_ph_hint,@PAppHtml contained keepend
syn region papp_CDATAx matchgroup=xmlCdataDecl start="<!\[CDATA\[" end="\]\]>" contains=papp_prep,papp_ph_perl,papp_ph_xml,papp_ph_xint            contained keepend
